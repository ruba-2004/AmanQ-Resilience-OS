const baseUrl =
  import.meta.env.VITE_CONTROLLER_URL || "http://localhost:5000";

const nodeBaseUrls = {
  S1: import.meta.env.VITE_NODE_S1_URL || "http://localhost:5001",
  S2: import.meta.env.VITE_NODE_S2_URL || "http://localhost:5002"
};
